...
export const categories: Category[] = [
  {
    ...
    name: 'Cafetería',
    emoji: '',
    description: 'Café para disfrutar solo o acompañado.',
  ...
  },
  {
    ...
    name: 'Hamburguesería',
    emoji: '',
    description: 'Variedad de Hamburguesas y mucho más.',
  ...
  },
  {
    ...
    name: 'Sándwichería',
    emoji: '',
    description: 'Sándwiches para cualquier momento del día.',
